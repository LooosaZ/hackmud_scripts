function(context, args)//target:#s.cyberdine.public,args:{arg1:value1,arg2:value2,etc3:etc3}
{
    ...
    if (!args || !args.target)return `loosaz.decorrupt{target:#s.cyberdine.public,args:"arg1:value1,arg2:value2,arg3:value3,etc:etcetera"}\n\nArguments are optional. All values will be converted to strings\n\nmacro:\nloosaz.decorrupt {{ target:#s.{0}, args:{1} }}`
